      ...
      !function(scope) {
        ...
        WebMidi2.prototype.enable = function(callback, sysex) {
          ...
          this.interface && this.interface.inputs.forEach(function(nInput) {
            for (var add = true, j = 0; j < this._inputs.length; j++) this._inputs[j]._midiInput === nInput && (add = false);
          ...
          this.interface && this.interface.outputs.forEach(function(nOutput) {
            for (var add = true, j = 0; j < this._outputs.length; j++) this._outputs[j]._midiOutput === nOutput && (add = false);
